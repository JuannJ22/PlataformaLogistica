...
public class UsuarioController {
    ...
    public List<Direccion> listarDirecciones() { return usuarioActual.getDireccionesFrecuentes(); }
    public void guardarDireccion(Direccion direccion) {
        if (direccion == null) throw new IllegalArgumentException("La dirección es obligatoria");
        usuarioActual.agregarDireccion(direccion);
    }
    public void eliminarDireccion(String idDireccion) { usuarioActual.eliminarDireccion(idDireccion); }

    public List<MetodoPago> listarMetodosPago() { return usuarioActual.getMetodosPago(); }
    ...
    public void eliminarMetodoPago(String idMetodo) { usuarioActual.eliminarMetodoPago(idMetodo); }
    ...
    public Envio crearSolicitudEnvio(Direccion origen, Direccion destino,
                                     ...
                                     Paquete paquete) {
        if (origen == null || destino == null) throw new IllegalArgumentException("Origen y destino son obligatorios");
    ...
    public void cancelarEnvio(String idEnvio) {
        ...
        if (envio == null) throw new IllegalArgumentException("El envío no existe");
        if (envio.getEstadoEnvio() != EstadoEnvio.SOLICITADO) throw new IllegalStateException("Solo se pueden cancelar envíos solicitados");
        plataforma.eliminarEnvio(idEnvio);
    }

    public Pago registrarPago(Envio envio, MetodoPago metodoPago) {
        if (envio == null) throw new IllegalArgumentException("Selecciona un envío");
        if (metodoPago == null) throw new IllegalArgumentException("Selecciona un método de pago");
